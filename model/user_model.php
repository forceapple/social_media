...
class user_model extends _Model_Interface{
	...
	public function login(){
		$query = "SELECT user.uid, user.username, user.f_name, user.l_name, user.profile_img FROM user WHERE user.username='".$this->username."' AND user.password=".$this->password;
